...
const Footer = () => {
  return (
    <footer className="bg-white pt-4 pt-md-5 pb-5 pb-md-3 px-3 px-md-5 border-top mb-5 mb-lg-0">
      <div className="container-fluid max-w-7xl mx-auto px-0">
        <div className="row g-4 g-md-5 mb-4 mb-md-5">
          {/* Column 1: Logo and Social */}
          <div className="col-12 col-md-6 col-lg-3 d-flex flex-column gap-2 gap-md-3">
            <div className="d-flex align-items-center gap-3">
              <div style={{ backgroundColor: '#2563eb', width: '32px', height: '32px' }} className="rounded-2 d-flex align-items-center justify-content-center">
                <span className="text-white fs-6 fw-bold">P</span>
              </div>
              <div>
                <h1 className="fs-6 fs-md-5 fw-bold text-dark m-0">PrepHire</h1>
              </div>
            </div>
          ...
          <div className="col-6 col-lg-3">
            <h3 className="text-dark fw-bold mb-3 mb-md-4 small text-uppercase tracking-wider">Quick Links</h3>
          ...
          {/* Column 3: Services */}
          <div className="col-6 col-lg-3">
            <h3 className="text-dark fw-bold mb-3 mb-md-4 small text-uppercase tracking-wider">Services</h3>
            <ul className="list-unstyled d-flex flex-column gap-2 mb-0">
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <h3 className="text-dark fw-bold mb-3 mb-md-4 small text-uppercase tracking-wider">Contact Us</h3>
            <ul className="list-unstyled d-flex flex-column gap-2 gap-md-3 mb-0">
              <li className="d-flex align-items-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-secondary mt-1"><rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
        ...
        {/* Bottom Bar */}
        <div className="pt-3 pt-md-4 border-top d-flex flex-column flex-md-row align-items-center justify-content-center gap-2 text-center">
          ...
          <div className="d-flex align-items-center gap-2">
            <Link to="/privacy-policy" className="text-secondary small text-decoration-none hover-primary-custom transition-colors fw-medium">Privacy</Link>
            <div className="border-start mx-1" style={{ height: '14px', width: '1px', backgroundColor: '#dee2e6' }}></div>
            <Link to="/terms-of-service" className="text-secondary small text-decoration-none hover-primary-custom transition-colors fw-medium">Terms</Link>
          </div>
        </div>
      </div>
    </footer>
